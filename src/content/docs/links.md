...
```
**Веб ссылка на нормативный правовй акт в системе регистров Минюста состоит из адреса сервера и GUID документа Word. Это актуально как для программы АРМ Аналитика так и для всех представлений на Портале Нормативные правовые акты в Российской Федерации (http://pravo.minjust.ru).**
