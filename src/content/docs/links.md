...
Одним из ключевых элементов оформления текста при введении регистров является простановка в этом тексте ссылок на упоминаемые нормативные правовые акты. В дальнейшем эти ссылки используются для перехода к другому НПА в программе АРМ Аналитика и на Портале Нормативные правовые акты в Российской Федерации (http://pravo.minjust.ru).

#### GUID

Для создания ссылки используется встроенный MS Office функционал генерации GUID.
