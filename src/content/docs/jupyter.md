...
Прямое подключение к локальной базе данных `MRegister36` (MS SQL Server) для глубокой аналитики:
...
2.  Проверьте VPN/локальное соединение для доступа к SQL-серверу `192.168.200.42`.
