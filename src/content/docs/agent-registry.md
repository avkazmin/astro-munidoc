...
### Сведения о нормативных правовых актах и документах
...
## Основные характеристики программно-аппаратного обеспечения
...
#### Портал «Нормативные правовые акты Российской Федерации»
...
## Обзор интерфейса системы ПС НПА ЕСИТО

### Начало работы – интерфейс Агента регистра НПА

#### Вход в систему для пользователей уполномоченных органов
...
#### Вход в систему в Минюсте России и его территориальных органах
...
### Общие принципы работы в системе (АРМы и их назначение, сервисы выгрузки)
...
### Интерфейс модуля АРМ Аналитика
...
### Интерфейс модуля АРМ Администрирование 
...
### По параметрам дополнительных сведений
...
## Внесение сведений о нормативных правовых актах в регистры
...
### Открытие существующего НПА для редактирования
...
### Редактирование текста НПА

#### Стилевое оформление текста НПА с использованием встроенных стилей
...
#### Проставление ссылок в тексте НПА
...
##### Установка ссылки на документ в целом
...
##### Установка ссылки на часть документа
...
#### Установка ссылки на дополнительные сведения
...
#### Установление и изменение статусов НПА
...
#### Привязка НПА к правовому классификатору
...
### Добавление к НПА дополнительных сведений
...
##### Постановка на правовую экспертизу
...
##### Постановка на антикоррупционную экспертизу
...
#### Добавление текста к дополнительным сведениям
...
#### Добавление новых источников дополнительных сведений
...
### Создание новой редакции существующего НПА
...
### Переключение между редакциями НПА
...
## Работа с реестром муниципальных образований
...
### Поиск карточек в реестре муниципальных образований
...
### Редактирование найденных карточек
...
#### Сохранение карточки с внесением записи об изменениях
...
#### Просмотр связанного с карточкой устава
...
#### Создание связей между муниципальными образованиями
...
#### Просмотр связей между муниципальными образованиями
...
### Создание новой карточки в реестре муниципальных образований
...
## Работа по контролю состояния базы данных регистра регионального уровня
...
#### Восстановление текущих редакций документов
...
### Удаление и восстановление редакции НПА
...
### Создание и редактирование типовых шаблонов НПА и дополнительных сведений
...
### Дополнительная обработка результатов поиска (сортировка, группировка, фильтрация по параметрам, экспорт в Excel)
...
#### Сводка по дополнительным сведениям
...
### Печать сводного отчета о выбранном НПА
...
### Подготовка форм статистической отчетности (№ 4, 6, 9 и др.)
...
## Ведение справочников в работе со справочниками системы

В настоящем разделе описаны возможности работы по контролю состояния баз данных с использованием АРМ Администрирования и существенным использованием прав Администратора в АРМ Аналитики. Для пользователей Минюста России и территориальных органов для использования возможностей необходимо обращение в службу технической поддержки НЦПИ, осуществляющей администрирование системы ПС НПА ЕСИТО в ЦОД Минюста России.

### Справочник источников дополнительных сведений
...
### Объединение нескольких значений справочника
...
#### Удаление карточки муниципального образования
...
#### Привязка карточек к территориям
...
## Порядок отправки обновлений

### Выгрузка НПА из регистра регионального уровня
...
### Подтверждение доставки на федеральном уровне
...
## Взаимодействие участников на региональном и муниципальном уровнях.

В настоящем разделе описаны возможности работы по контролю состояния баз данных с использованием АРМ Администрирования и существенным использованием прав Администратора в АРМ Аналитики. Для пользователей Минюста России и территориальных органов для использования возможностей необходимо обращение в службу технической поддержки НЦПИ, осуществляющей администрирование системы ПС НПА ЕСИТО в ЦОД Минюста России.

### Выгрузка уставов муниципальных образований территориальными органами Минюста
...
### Загрузка уставов муниципальных образований
...
### Загрузка НПА, поступивших в электронном виде из муниципальных образований
...
### Контроль форм статистической отчётности через АРМ Аналитики
...
## Восстановление панелей в АРМ Ввода
